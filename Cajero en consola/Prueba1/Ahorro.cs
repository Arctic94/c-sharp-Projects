...
namespace Prueba1
{
    public class Ahorro:Cuenta
    {
        ...
        public Ahorro(string tipoCuenta,string rut,string nombre, string sucursal, double saldo, DateTime fechaGiro, int monto, int cantGiros, DateTime fechaCuenta, long numCuenta)
